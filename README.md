...
|---|---|---|---|
| β = 0.37 點/√口，HAC t = 4.8，n = 1,346 | 期貨，行為版 θ = 0.79 / 0.83 | 13:25→13:30 只有 1/4，β 0.10 vs 0.38，t 1.9–2.5 | 每口淨 17 點，Sharpe 2.4，前 10 天佔利潤 108% |
...
### P3 擁擠度：13:25–13:30 只提前反映約四分之一

$$\Delta\text{basis}(13{:}25 \to 13{:}30) = \alpha + \beta_1 \hat r_t + \beta_2\, \text{sign}(F)\sqrt{N} + \varepsilon$$

| 被解釋 | β(sign F·√N) | t | n |
|---|---|---|---|
| 13:25→13:30 basis，全 | 0.097 | 2.5 | 1,346 |
| 13:25→13:30 basis，排除版 | 0.113 | 1.9 | 710 |
| 13:29:59→13:30:00 收盤瞬間，全 | −0.062 | −7.9 | 1,346 |
| 13:30→13:45，全 | 0.380 | 4.5 | 1,346 |
| 13:30→13:45，排除版 | 0.381 | 3.6 | 710 |

試撮期間對流量方向的反應是 13:30 後的四分之一（0.097 vs 0.380），且收盤瞬間 13:29:59→13:30:00 反向 0.062·√N，13:30 第一筆進場前的淨提前定價接近零。第一版用 951 天子樣本 t 只有 1.5，補齊 1,354 天後 t 2.5，所以「完全沒有提前定價」改成「少量提前定價，不影響 κ 的量級」。

副產品：收盤 surprise $\hat r = I_{close} - I_{13:25}$ 的 std 50 點，期貨在 13:25–13:30 只跟了 40%，隔天開盤回吐 25%。集合競價本身噪音很大，期貨不理它是對的。
...
1. 五條獨立證據：投信當天在期貨端照 $2Ar$ 平衡（θ 0.8，前後一天都沒有）；流量落在 13:30–13:45（差分 β₁ 2.65）；13:25–13:30 只提前反映四分之一；13:30 後的漂移只跟收盤對收盤報酬有關、跟日內路徑無關；各年 edge 大小隨 $\Sigma A \cdot \sigma_w$ 一起變。
